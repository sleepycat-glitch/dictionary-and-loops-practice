...
def add_student():
    ...
    # Confirmation
    print(f"\nStudent {full_name} added succesfully!")
    print(new_student)
    print("Total studens in the system:", len(students))
...
while True:
    ...
    if choice == "1":
        ...
        if result:
           ...
           print(f"Secondary email: {result['secondary_emial']}")
        else:
            # Inform the user if the student was not found
            print("\nStudent not found.")

    elif choice == "2":
        add_student()   # calls function
